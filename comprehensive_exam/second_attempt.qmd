...
Anything below this line needs a lot of work
...
<!-- No, it doesn't. You're going to develop some code to break ties in a way consistent with the grammar of graphics and tidyselect (so that users can break ties on some axes but not others, if they want, with intelligent defaults).  -->
