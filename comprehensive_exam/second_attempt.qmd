...
#|   and ordered by their Year A values, eliminating within-band crossings. The gap
#|   between 2000 and 2001 is preserved by deriving the spread width from the global
#|   axis resolution $\\delta_j$. Remaining crossings are necessary crossings induced
#|   by the data structure rather than artifacts of tie-breaking."
...
spread <- delta * 2.5            # band width — wider than delta but stays < the gap
