...
The `space` parameter specifies the proportion of the y-axis allocated for spacing between levels of categorical variables (Figure @fig-categorical-fix).
...
When ggpcp connects categorical and numerical variables, the tie-breaking algorithms keep the triangular patterns clear (Figure @fig-boxes). 
...
1. **R Package Release (ggpcp Pull Request):**
