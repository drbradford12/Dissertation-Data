...
```{r vdc-example, fig.cap="Van der Corput Sequence Visual", out.width="35%", eval=FALSE}
...
|---------|-----------|-------------|
| Angle | Golden angle ($137.5^\circ$) | Golden ratio × 2π (224.4°) |
...
```{r golden-ratio, fig.cap="1-dimension Example of the Golden Ratio", out.width="30%", eval=FALSE}
