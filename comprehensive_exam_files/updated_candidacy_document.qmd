...
The mathematical principle: **The Golden Angle** = $137.508° = 360° \times (2 - \phi)$
...
```{r intelligent-demo, fig.cap="Intellient jittering resolves ties", fig.width=10, fig.height=5}
...
|---------|-----------|-------------|
| Angle | Golden angle (137.5°) | Golden ratio × 2π (224.4°) |
| Scaling | Square root: $\sqrt{j/n}$ | Linear: $j/n$ |
| Projection | 2D spiral → 1D | 1D cosine modulation |
