...
Traditional PCPs were primarily designed to [display]{.svp} continuous data.
However, real-world datasets often contain a mix of continuous, ordinal, and categorical data.
[In parallel to the development of numerical PCPs, a number of categorical plots with similar goals developed. Over time, the different approaches to categorical and numerical variables converged, leading to several different types of mixed-variable, parallel axis plots.]{.svp}
[We will first consider categorical plots with parallel vertical axes, and then examine mixed-type variants.]{.svp}
...
<!-- XXX I Have no idea what you're getting at here XXX -->
...
## Categorical and Mixed Variable Parallel Representations
...
[This]{.svp} grammar-based adaptation [retains the]{.svp} established behaviors of parallel categorical displays while providing additional [options to handle]{.svp} edge cases like categorical ties. 
...
This ensures that the visualizations are]{.db} [perceived accurately, preserving the marginal proportions while still connecting observations across parallel axes.]{.svp} 
