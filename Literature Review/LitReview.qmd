...
@fig-pcpScatter illustrates the three extreme values of Pearson's correlation coefficient $r (r=-1,0,1)$ using two types of visualizations: scatterplots (top row) and parallel coordinate plots (bottom row).
...
[In effect, the parallel coordinate plot shows the calculation of Kendall's $\tau$, a robust version of Pearson's correlation coefficient which works with ranks.]{.svp}
...
#| layout-valign: bottom
#| fig-cap: "The original Sankey diagram representing the thermal efficiency of steam engines created by civil engineer, Matthew Sankey."
#| fig-width: 4
#| fig-height: 4
