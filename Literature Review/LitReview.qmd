...
[@hofmann2013]{.db} improved the framework for visualizing data by adding Hammock plots to a grammar-based system [called `ggparallel`]{.db}. [What? No, that's the first ggpcp paper draft -- it didn't talk about Hammock plots. You want to look into the research Heike did with Vendettuoli circa 2012-2015 for hammock plots and variations]{.svp}
