...
These ideas improve the interpretability of interactive PCRs, hybrid PCRs combining data kinds, and continuous PCRs. 
...
Combining these two tools makes looking for patterns and exploring large datasets easier, [@healey1999]. <!--[Citation needed]{.svp}-->
...
@heinrich2013 shows that these methods make parallel coordinate plots easier to understand, more accurate, and better able to find groups and trends, all of which are very important for data analysts.
...
By flipping some axes and putting related factors closer together (like body mass and flipper length), the plot makes species-based trends stand out more: The Gentoo (purple) tends to have a shallower bill but a bigger body and longer flippers, while the Adelie (pale blue) tends to have the opposite pattern.
