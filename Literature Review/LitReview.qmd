...
[Parallel sets plots are similar to PCPs, but are designed for categorical variables.]
...
[The `ggparallel` package]{.svp} [@hofmann2013]{.db} [provided a grammar-based interface]{.svp} for visualizing [multivariate categorical]{.svp} data, implementing Hammock plots [@schonlau2024].
