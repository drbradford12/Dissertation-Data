...
For example, if a vast dataset has many similar or similar values, separating the tied values can help the viewer see trends and relationships without having to think too hard [@tufte2001].
