...
R'_{i,j} =  \begin{cases}
          ...
          \end{cases}
$$
- $\epsilon$: A small constant (e.g., 0.01) to control the influence of the previouse rank.
...
```
<!-- Something is wrong here in the year category for the reason that I think that the numerical ties, but if we ensure that the year is a categorical variable does this change the outcome of the graphic? Chang-->
